...
""".format(
    ...
    def run(self, workspace):
        ...
        df_with_outliers_path = (get_default_image_directory() + "/" + "outliers_dataframe.csv")
        df_with_outliers.to_csv(df_with_outliers_path)   # user receives this csv as output at this point
